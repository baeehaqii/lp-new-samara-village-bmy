import { ShieldCheck, Trees, Cctv, CarFront, CircleMinus, IdCard, Home, Zap, Leaf } from "lucide-react"
  ...
  return (
    <section id="fasilitas" className="features-section">
      <div className="container">
        <h2 className="section-title">5 Keunggulan Samara Village Bumiayu</h2>
        <p className="section-subtitle">
          Hunian Modern dengan Kualitas Premium di Lokasi Strategis Bumiayu
        </p>
