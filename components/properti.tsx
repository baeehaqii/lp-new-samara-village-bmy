...
export default function Properties() {
  ...
  const siteplan = {
    id: "siteplan-1",
    image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1761987801/Screenshot_2025-11-01_at_16.01.25_plesft.avif",
    name: "Siteplan Samara Village Bumiayu",
    description:
      "Masterplan perumahan Samara Village Bumiayu yang menampilkan layout, jalan, ruang terbuka hijau, dan fasilitas umum dengan one-gate system untuk keamanan optimal.",
  }
  ...
  const location = {
    embed: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.982586818152!2d109.01434917590277!3d-7.242820171142429!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6f8f00306eedb9%3A0x556fff29247db5c1!2sSamara%20Village%20Bumiayu!5e0!3m2!1sen!2sid!4v1761987572870!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
    name: "Denah Lokasi Samara Village Bumiayu",
    description: "Lokasi strategis di Bumiayu dengan akses mudah ke berbagai fasilitas pendidikan, kesehatan, pusat perbelanjaan, dan fasilitas publik.",
  }
    ...
    <section id="tipe-rumah" className="section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Temukan rumah impian Anda di Samara Village Bumiayu dengan berbagai tipe yang dirancang khusus untuk keluarga muda yang ingin memiliki rumah pertama. Harga mulai dari 150 jutaan.
        </p>
          ...
          <div className="location-container">
            ...
            <div className="location-content">
              ...
              <div className="location-button-container">
                <Link
                  href="https://maps.app.goo.gl/qb2HuPwkDm3rw7DT7"
                  target="_blank"
